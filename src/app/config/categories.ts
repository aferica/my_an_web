export const Categories = {
    male: [
        ...
        {major:"军事",mins:["军事战争","战争幻想","谍战特工","军旅生涯","抗战烽火"]},
        {major:"游戏",mins:["游戏生涯","电子竞技","虚拟网游","游戏异界"]},
        {major:"竞技",mins:["体育竞技","篮球运动","足球运动","棋牌桌游"]},
        {major:"科幻",mins:["星际战争","时空穿梭","未来世界","古武机甲","超级科技","进化变异","末世危机"]},
        {major:"灵异",mins:["推理侦探","恐怖惊悚","悬疑探险","灵异奇谈"]},
        {major:"同人",mins:["武侠同人","影视同人","动漫同人","游戏同人","小说同人"]},
        {major:"轻小说",mins:[]}],
    female: [
        {major:"古代言情",mins:["穿越时空","古代历史","古典架空","宫闱宅斗","经商种田"]},
        {major:"现代言情",mins:["豪门总裁","都市生活","婚恋情感","商战职场","异术超能"]},
        {major:"青春校园",mins:[]},
        {major:"纯爱",mins:["古代纯爱","现代纯爱"]},
        {major:"玄幻奇幻",mins:["玄幻异世","奇幻魔法"]},
        {major:"武侠仙侠",mins:["武侠","仙侠"]},
        {major:"科幻",mins:[]},
        {major:"游戏竞技",mins:[]},{major:"悬疑灵异",mins:["悬疑","灵异"]},
        {major:"同人",mins:["小说同人","动漫同人","影视同人","游戏同人","耽美同人"]},
        {major:"女尊",mins:[]},
        {major:"莉莉",mins:[]}],
    picture:[
        {major:"热血",mins:[]},
